...
cl_size<-tapply(as.character(sc@meta.data$seurat_clusters), sc@meta.data$seurat_clusters, length)
...
md <- read_rds("4_harmony_cellClass_RVT/sc.NormByLibrary.ref.Harmony.singler.RVT.res0.8.rds") %>%
    as.data.frame %>%
...
outFolder="5_harmony_cellClass_RVT_res0.8_plots/"
