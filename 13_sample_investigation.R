...
#############################################################################################
# Fores plot based on deconv analysis (DEGs overlap with wikipathways -myometrium pathway)  
...
################################################
# Forest plot based on single cell gene expression data on selected genes from deconv analysis
################################################
