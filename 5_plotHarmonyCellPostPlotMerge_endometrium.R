...
#sc.NormByLocationRep.Harmony.rds

##pred.singler <- read_rds("./4_harmony_cellClass.v3/sc.NormByLibary.ref.Harmony_singler.rds") %>%
##    as.data.frame()

md <- read_rds("./4_harmony_cellClass_endometrium/sc.NormByLocation.ref.Harmony.singler.rds") %>%
    as.data.frame %>%
...
outFolder="5_harmony_cellClass_endometirum_res0.8_plots/"
